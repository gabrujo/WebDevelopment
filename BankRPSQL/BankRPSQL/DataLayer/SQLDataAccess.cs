...
namespace BankRPSQL.DataLayer
{
    public class SQLDataAccess : IDataAccess
    {
       ...
       DbConnection conn = null, DbTransaction sqtr = null, bool bTransaction = false)
        ...
        public object GetSingleAnswer(string sql, List<DbParameter> PList, DbConnection
    conn = null, DbTransaction sqtr = null, bool bTransaction = false)
        {
            object obj = null;
            if (bTransaction == false)
                conn = new SqlConnection(CONNSTR);
        ...
        public int InsertUpdateDelete(string sql, List<DbParameter> PList, DbConnection
       conn = null, DbTransaction sqtr = null, bool bTransaction = false)
        {
            int rows = 0;
            if (bTransaction == false)
